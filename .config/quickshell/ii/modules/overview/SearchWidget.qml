...
Item { // Wrapper
    ...
    property var searchActions: [
        {
            action: "accentcolor",
            execute: args => {
                Quickshell.execDetached(["bash", "-c", `${Directories.wallpaperSwitchScriptPath} --noswitch --color ${args}`]);
            }
        },
        {
            action: "dark",
    ...
    // Debounce timer to reduce search frequency
    Timer {
        id: searchDebounceTimer
        interval: 150 // Wait 150ms before processing search
        onTriggered: {
            searchModel.refresh();
        }
    }
    ...
    Rectangle { // Background
        ...
        ColumnLayout {
                ...
                TextField { // Search box
                    ...
                    Behavior on implicitWidth {
                        ...
                        NumberAnimation {
                            ...
                            easing.type: Easing.OutCubic  // Simpler easing
                        }
                    }
            ...
            ListView { // App results
                ...
                highlightMoveDuration: 50  // Faster highlight movement
                ...
                Connections {
                    ...
                    function onSearchingTextChanged() {
                        // Don't immediately update, let debounce timer handle it
                        if (appResults.count > 0 && !searchDebounceTimer.running)
                            appResults.currentIndex = 0;
                    }
                }
                ...
                model: ScriptModel {
                    ...
                    function refresh() {
                        if (root.searchingText === cachedSearchText) return;
                        cachedSearchText = root.searchingText;
                    ...
                    // Initialize with empty values to prevent initial calculation
                    values: []
                }

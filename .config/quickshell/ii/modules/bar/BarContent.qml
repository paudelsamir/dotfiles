...
Item { // Bar content region
    ...
    readonly property int centerSideModuleWidth: baseCenterSideModuleWidth
    ...
    FocusedScrollMouseArea { // Left side | scroll to change brightness
        ...
        Row {
            ...
            Media {
                visible: (Config.options?.bar?.modules?.media ?? true) && root.useShortenedForm < 2
                implicitWidth: 45
            }
    ...
    Row { // Middle section
        ...
        MouseArea {
            ...
            BarGroup {
                ...
                Loader {
                    Layout.alignment: Qt.AlignVCenter
                    active: Config.options?.bar?.weather?.enable ?? false
    ...
    FocusedScrollMouseArea { // Right side | scroll to change volume
        ...
        RowLayout {
                    ...
                    Revealer {
                        ...
                        RowLayout {
                            ...
                            StyledText {
                                ...
                                color: Battery.isCritical ? Appearance.colors.colError
                                    : (Battery.isCharging ? (Appearance.inirEverywhere ? Appearance.inir.colPrimary : Appearance.colors.colPrimary)
            ...
            Loader {
                active: Config.options?.bar?.utilButtons?.showDarkModeToggle ?? false
                visible: active
                Layout.alignment: Qt.AlignVCenter
                Layout.leftMargin: 4
                sourceComponent: MouseArea {
                    ...
                    Rectangle {
                        ...
                        MaterialSymbol {
                            ...
                            fill: 1
                            text: Appearance.m3colors.darkmode ? "dark_mode" : "sunny"

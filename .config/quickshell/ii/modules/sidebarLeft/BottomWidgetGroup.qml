...
Rectangle {
    ...
    property var tabs: [
        {"type": "pomodoro", "name": Translation.tr("Pomodoro"), "icon": "search_activity", "widget": pomodoroTimerWidget},
        {"type": "timer", "name": Translation.tr("Timer"), "icon": "timer", "widget": timerWidget},
        {"type": "stopwatch", "name": Translation.tr("Stopwatch"), "icon": "schedule", "widget": stopwatchWidget}
    ]
    ...
    RowLayout {
        ...
        StyledText {
            Layout.margins: 10
            Layout.leftMargin: 0
            text: Translation.tr("Timer Tools")

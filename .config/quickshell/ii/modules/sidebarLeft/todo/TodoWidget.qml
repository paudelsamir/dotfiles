...
Item {
    ...
    Item {
        ...
        Rectangle { // The dialog
            ...
            property string selectedSection: "Important"

            function addTask() {
                if (todoInput.text.length > 0) {
                    Todo.addTask(todoInput.text, dialog.selectedSection)
                    todoInput.text = ""
                    root.showAddDialog = false
                    root.currentTab = 0
                }
            ...
            ColumnLayout {
                ...
                RowLayout {
                    ...
                    RippleButton {
                        ...
                        colBackground: dialog.selectedSection === "Important" ? Appearance.colors.colSecondaryContainer : "transparent"
                        colBackgroundHover: Appearance.colors.colLayer1Hover
                        colRipple: Appearance.colors.colRipple
                        implicitHeight: 28
                        onClicked: dialog.selectedSection = "Important"
                        contentItem: StyledText {
                            text: Translation.tr("Important")
                            font.pixelSize: Appearance.font.pixelSize.small
                            font.weight: dialog.selectedSection === "Important" ? Font.Medium : Font.Normal
                            color: dialog.selectedSection === "Important" ? Appearance.m3colors.m3onSecondaryContainer : Appearance.m3colors.m3onSurfaceVariant
                        }
                    }

                    RippleButton {
                        text: Translation.tr("Usual")
                        buttonRadius: Appearance.rounding.small
                        colBackground: dialog.selectedSection === "Usual" ? Appearance.colors.colSecondaryContainer : "transparent"
                        colBackgroundHover: Appearance.colors.colLayer1Hover
                        colRipple: Appearance.colors.colRipple
                        implicitHeight: 28
                        onClicked: dialog.selectedSection = "Usual"
                        contentItem: StyledText {
                            text: Translation.tr("Usual")
                            font.pixelSize: Appearance.font.pixelSize.small
                            font.weight: dialog.selectedSection === "Usual" ? Font.Medium : Font.Normal
                            color: dialog.selectedSection === "Usual" ? Appearance.m3colors.m3onSecondaryContainer : Appearance.m3colors.m3onSurfaceVariant
                        }
                    }

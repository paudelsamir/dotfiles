...
ContentPage {
    ...
    SettingsCardSection {
        ...
        SettingsGroup {
            StyledText {
                Layout.fillWidth: true
                text: Translation.tr("Automatically checks the git repository for new versions and shows a notification in the bar.")
            ...
            ConfigSpinBox {
                ...
                StyledToolTip {
                    text: Translation.tr("How often to check for updates (in minutes). Default: 360 (6 hours)")
                }
            }

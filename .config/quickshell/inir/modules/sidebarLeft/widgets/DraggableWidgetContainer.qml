...
Item {
    ...
    readonly property var defaultOrder: ["media", "week", "context", "note", "launch", "controls", "status", "crypto", "wallpaper", "github", "worldclock"]
    ...
    readonly property bool showGithub: Config.options?.sidebar?.widgets?.github ?? true
    ...
    ColumnLayout {
        ...
        Repeater {
            ...
            delegate: Item {
                ...
                readonly property bool needsMargin: ["context", "note", "media", "crypto", "wallpaper", "github"].includes(modelData)

            ...
            RowLayout {
                ...
                Rectangle {
                    ...
                    ColumnLayout {
                        ...
                        StyledText {
                            Layout.fillWidth: true
                            text: Translation.tr("Everything the shell has to offer. Recommended if you like to tinker.")
                            font.pixelSize: Appearance.font.pixelSize.smaller
                            wrapMode: Text.WordWrap
                            color: advancedCard.selected
                                ? Appearance.colors.colOnPrimaryContainer
            ...
            RowLayout {
                ...
                RippleButton {
                    ...
                    RowLayout {
                        ...
                        StyledText { text: Translation.tr("Wiki"); font.pixelSize: Appearance.font.pixelSize.small }
                    }
                }
